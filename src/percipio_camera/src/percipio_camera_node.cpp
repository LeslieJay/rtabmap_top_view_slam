 ...
 * @LastEditTime: 2025-04-01 13:53:28
 * @Description: 图漾深度相机ros节点文件，修改qos策略，完成彩色图和深度图对齐
 * 
 * Copyright (c) 2024 by wei.canming, All Rights Reserved. 
 */
...
void PercipioCameraNode::publishColorFrame(percipio_camera::VideoStream& stream)
{
    ...
    image_info.header.stamp = node_->get_clock()->now();
