...
LastEditTime: 2025-04-22 17:55:18
Description: 基于rtabmap官方提供的launch文件，修改rtabmap的配置和启动参数
'''
#
    ...
    return [
        ...
        Node(
            ...
            remappings=[
                ...
                ('rgbd_image', LaunchConfiguration('rgbd_topic_relay')),
                ('cloud', 'voxel_cloud')]),
        # @LESLIE 小车base_link 到 相机安装位置中心的几何变换  # -1.57079632679
        Node(
            package='tf2_ros', executable='static_transform_publisher', output='screen',
            arguments=['0.23', '0.0', '0.3', '0.0', '-1.57079632679', '0.0', 'base_link', 'camera_link']),
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # Config files
        DeclareLaunchArgument('cfg',      default_value='/home/huanyue/weicanming/GitLabProjects/rtabmap_vslam/top-view-vslam/rtabmap_ws/src/config.ini',                        description='To change RTAB-Map\'s parameters, set the path of config file (*.ini) generated by the standalone app.'),
        ...
        # @LESLIE 修改话题名称为图漾相机实际的话题
        DeclareLaunchArgument('rgb_topic',           default_value='/camera/color/image_processed',       description=''),
        DeclareLaunchArgument('depth_topic',         default_value='/camera/depth/image_processed', description=''),
        DeclareLaunchArgument('camera_info_topic',   default_value='/camera/color/camera_info_processed',            description=''),
