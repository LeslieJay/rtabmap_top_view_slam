 ...
 * @LastEditTime: 2025-08-22 15:29:35
...
CmdVelListener::CmdVelListener() : Node("cmd_vel_listener")
{
  ...
  // 创建发布者，发布差速轮速度
  wheel_speed_pub_ = this->create_publisher<usbcan_jay_pkg::msg::DifferentialWheel>(
    "ShaoGuan/AG05D/N38/DifferentialWheel_vel", qos);
...
{
  auto msg = usbcan_jay_pkg::msg::DifferentialWheel();
