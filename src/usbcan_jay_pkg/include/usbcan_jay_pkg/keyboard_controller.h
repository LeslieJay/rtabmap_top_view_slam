 ...
 * @LastEditTime: 2025-08-04 13:22:48
...
#include <unistd.h>
#include <iostream>
#include "usbcan_jay_pkg/msg/differential_wheel.hpp"  // 替换为实际的消息头文件
#include <fcntl.h>
#include <unistd.h>
...
private:
  ...
  rclcpp::Publisher<usbcan_jay_pkg::msg::DifferentialWheel>::SharedPtr speed_pub_;
